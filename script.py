ffmpeg = open("infbuf_mpeg_filtered.log",'r') #ffmpeg side log-file (filtered)
ffplay = open("infbuf_play_filtered.log",'r') #ffplay side log-file (filtered)
fout = open("buf_infbuf.plot",'w') #output file.
